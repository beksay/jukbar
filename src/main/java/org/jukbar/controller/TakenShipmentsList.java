...
@ManagedBean
@ViewScoped
public class TakenShipmentsList extends BaseController implements Serializable {
	...
	public void filterData() {
		...
		filters.add(new FilterExample("status", ShipmentStatus.TAKEN, InequalityConstants.EQUAL));  
